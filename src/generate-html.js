...
const managersHandler = (managers) => {
...
const engineersHandler = (engineers) => {
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item card-header">
                    <h4 class="card-title">${name}</h4>
                    <h5 class="card-text"><i class="uil uil-github-alt"></i>
                        Engineer</h5>
                </li>
                <div class="card-body-wrapper">
                    <li class="list-group-item"><span>ID:</span> ${id}</li>
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item card-header">
                    <h4 class="card-title">${name}</h4>
                    <h5 class="card-text"><i class="uil uil-graduation-cap"></i>
                        Intern</h5>
                </li>
                <div class="card-body-wrapper">
                    <li class="list-group-item"><span>ID:</span> ${id}</li>
  ...
  <body>
      <div class="nav-wrapper">
          <nav class="navbar">
              ...
              <i class="uil uil-android"></i><i class="uil uil-android"></i><i class="uil uil-android"></i> My Team <i class="uil uil-android"></i><i class="uil uil-android"></i><i class="uil uil-android"></i>
              </h1>
          </nav>
      </div>
      <div>
      ...
      <div class="row">
                  ${managersHandler(managers).join("")}
            </div>
        </div>
  
        <div class="container" id="engineers-container">
            <div class="row">
                  ${engineersHandler(engineers).join("")}
              </div>
          </div>
  
          <div class="container" id="interns-container">
          <div class="row">
                  ${internsHandler(interns).join("")}
              </div>
          </div>
      </div>
